...
using TechReserveSystem.Shared.Communication.Resources;
    ...
    public class RegisterReservationUseCase : IRegisterReservationUseCase
    {
        ...
        public async Task<EquipmentReservationResponse> Execute(EquipmentReservationRequest request)
        {
            ...
            if (equipment is null)
                throw new NotFoundExceptionError(ResourceMessagesException.EQUIPMENT_NOT_FOUND);

            var user = await _userRepository.GetById(request.UserId);
            if (user is null)
                throw new NotFoundExceptionError(ResourceMessagesException.USER_NOT_FOUND);
            ...
            var result = new EquipmentReservationResponse
            {
                ...
                Details = isEquipmentAvailability ? CommunicationMessages.RESERVATION_SUCCESS : CommunicationMessages.EQUIPMENT_NOT_AVAILABLE,
            };
